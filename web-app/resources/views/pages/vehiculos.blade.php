                ...
                vehiculos.forEach(vehiculo => {
                    ...
                    <div class="bg-darksurface border border-white/10 rounded-[1.5rem] overflow-hidden hover:border-brand-500/50 hover:bg-[#1f2937] transition-all duration-300 group shadow-lg relative">
                        ...
                        <div class="p-7 relative z-10">
                            ...
                            <div class="mb-6">
                                <h3 class="text-2xl font-extrabold text-white group-hover:text-brand-300 transition-colors uppercase">${vehiculo.modelo}</h3>
                                <p class="text-sm font-medium text-slate-400 mt-1 capitalize">${vehiculo.color || 'Sin color'}</p>
                            </div>
                            ...
                            <div class="bg-[#090e1f]/80 rounded-xl p-4 border border-white/5 border-dashed text-center mb-6 shadow-inner">
                                ...
                                <p class="text-xl font-mono font-extrabold text-brand-300 tracking-[0.2em] drop-shadow-[0_0_8px_rgba(165,180,252,0.3)]">${vehiculo.placa}</p>
                            </div>
                            ...
                            <div class="flex items-center gap-4 pt-5 border-t border-white/5">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-slate-200">Usuario ${vehiculo.usuario_id}</p>
