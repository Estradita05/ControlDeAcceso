    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <View style={styles.card}>
          ...
          <TextInput style={styles.input} placeholder="Ej. Alexis Hernández" />

          <Text style={styles.label}>Matrícula / ID</Text>
          <TextInput style={styles.input} placeholder="1240XXXXX" keyboardType="numeric" />

          <Text style={styles.label}>Correo Institucional</Text>
          <TextInput style={styles.input} placeholder="usuario@edu.mx" keyboardType="email-address" />
